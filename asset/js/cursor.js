    ...
    if (!isSpecialPage()) {
        window.onclick = function (event) {
            ...
            var texts = [
                ...
                "「但是，就像是上钩的鱼儿再也得不到鱼儿一样，<br/>又好比是从熊熊燃烧的沉醉激情中清醒过来一样，<br/>一旦被得到，<br/>爱的价值就会极端地降低」",
                // 诗词
                "世间甲子须臾事，<br/>逢着仙人莫看棋。",
                "人世几回伤往事，<br/>山形依旧枕寒流。",
                "梦里不知身是客，<br/>一晌贪欢。",
                ...
                "她把灵魂比喻成一口井。<br/>她说，每个人的心里都有自己的一口井。<br/>井里累积的是人们的所思所感。为了把自己的感受传达给其他人，你就得把它从井里取出来，再带到别人的井那里。<br/>但你的手装不了多少，沿途还会洒落一些，到最后你只能传达出一小部分。<br/>所以我们才要为之努力。你要给自己做个木桶。<br/>在现实世界里，它可以是文字，音乐或者图画。<br/>人们终有一天会找到能够装载自己灵魂的器皿。",
                // 歌曲
                "♪ おお 神の刃は 人類の愛 ♪",
